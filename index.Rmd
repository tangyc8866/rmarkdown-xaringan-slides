...
knitr::include_graphics("./loc-figs/Julia.jpg")
```
...
knitr::include_graphics("./loc-figs/job.jpg")
```
...
knitr::include_graphics("./loc-figs/Yihuibooks.png")
```
...
.pull-right[
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics("./loc-figs/rstudio-console.jpg")
```
]
...
knitr::include_graphics("./loc-figs/rstudio-source-1.jpg")
```

- Rmd/Qmd文档编辑器
```{r, echo = FALSE, out.width = "50%"}
knitr::include_graphics("./loc-figs/rstudio-source-2.jpg")
```
...
knitr::include_graphics("./loc-figs/rstudio-aviation.jpg")
```
]
...
knitr::include_graphics("./loc-figs/rstudio-workspace.jpg")
```
...
knitr::include_graphics("./loc-figs/rstudio-plot-1.jpg")
```
...
```{r, echo = FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("./loc-figs/rstudio-plot-2.jpg")
```

- Packages： R包管理器(安装，加载，更新)

```{r, echo = FALSE, fig.align='center', out.width = "50%"}
knitr::include_graphics("./loc-figs/rstudio-plot-3.jpg")
```
...
knitr::include_graphics("./loc-figs/RMD-2.jpg")
```
]
...
```{r, echo=FALSE, out.width = "60%"}
knitr::include_graphics("./loc-figs/RMarkdownFlow.jpg")
```
